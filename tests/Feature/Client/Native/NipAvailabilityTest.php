...
use Revolution\Nostr\Client\Native\NativeNip19;
...
class NipAvailabilityTest extends TestCase
{
    public function test_all_nip_methods_are_available_on_facade()
    {
        ...
        $this->assertInstanceOf(NodeNip04::class, Nostr::driver('node')->nip04());
        $this->assertInstanceOf(NativeNip05::class, Nostr::driver('native')->nip05());
        $this->assertInstanceOf(NativeNip17::class, Nostr::driver('native')->nip17());
        $this->assertInstanceOf(NativeNip19::class, Nostr::driver('native')->nip19());

        // Test that the facade methods work with default driver (should be native)
        $this->assertInstanceOf(NativeNip05::class, Nostr::nip05());
        $this->assertInstanceOf(ClientNip17::class, Nostr::nip17());
        $this->assertInstanceOf(ClientNip19::class, Nostr::nip19());
    }
